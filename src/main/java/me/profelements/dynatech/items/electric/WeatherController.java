...
public class WeatherController extends AbstractElectricTicker implements RecipeDisplayItem {
    ...
    public List<ItemStack> getDisplayRecipes() {
        ...
        items.add(new CustomItemStack(Material.DIAMOND, "&fDeixa o dia ensolarado."));

        items.add(new ItemStack(Material.LILAC));
        items.add(new CustomItemStack(Material.DIAMOND, "&fChove quando o vovô ronca."));

        items.add(new ItemStack(Material.CREEPER_HEAD));
        items.add(new CustomItemStack(Material.DIAMOND, "&fTrovão e relâmpago!"));
